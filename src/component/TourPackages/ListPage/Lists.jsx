...
const Lists = () => {
  ...
  useEffect(() => {
    const fetchDestinations = async () => {
      try {
        const res = await fetch("https://admin.climaxholidays.com/api/HolidayPackages/destinations");
  ...
  const fetchData = async () => {
    const res = await axios.get(`https://admin.climaxholidays.com/api/HolidayPackages/destinations/${pack}`);
    ...
    try {
      const rescity = await axios.get("https://admin.climaxholidays.com/api/HolidayPackages/depcities");
  ...
  const fetchModifiedSearch = async () => {
    try {
      const resx = await axios.post("https://admin.climaxholidays.com/api/HolidayPackages/ModifySearch", {
        fromLocation,
