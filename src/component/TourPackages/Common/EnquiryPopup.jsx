...
const EnquiryPopup = ({destination}) => {
    ...
    const handleQuickSubmit = async () => {
        ...
        try {
            const res = await axios.post("https://admin.climaxholidays.com/api/HolidayPackages/quick_enquiry", {
                name,
                email,
                phone,
                destination,
            ...
            {showMobileModal && (
                <div className="BoxDetailAbove">
                    <div className="BoxDetail">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=919599408232&text=I+need+Europe+tours+packages&type=phone_number&app_absent=0" className="inbox brd">
                            <div className="img">
                                <img src="https://hldak.mmtcdn.com/prod-s3-hld-hpcmsadmin/holidays/images/phonixImages/Get%20a%20quote%20large.png" />
                            </div>
                            <div classname="detailContent">
                        ...
                        <a href="tel:+919599408232" className="inbox">
                            <div className="img">
                                <img src="https://hldak.mmtcdn.com/prod-s3-hld-hpcmsadmin/holidays/images/phonixImages/Get%20a%20quote%20large.png" />
                            </div>
                            <div classname="detailContent">
