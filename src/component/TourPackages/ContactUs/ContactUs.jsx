  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      Swal.fire({
        ...
        html: `<ul style="text-align:left;">${Object.values(validationErrors)
          .map((err) => `<li>${err}</li>`)
          .join("")}</ul>`,
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="contact-item">
                ...
                <div className="contact-item-content">
                  ...
                  <h6>
                    <a href="mailto:sales@climaxholidays.com">
                      sales@climaxholidays.com
                    </a>
                  </h6>
                </div>
              </div>
              ...
              <div className="contact-item">
                ...
                <div className="contact-item-content">
                  ...
                  <a href="https://maps.app.goo.gl/hBdNok4XSiJjBRMQ8" target="_blank">
                    <h6>
                      Ansal Chamber-2, 125, Bhikaji Cama Place, New Delhi, Delhi 110066
                    </h6>
                  </a>
                </div>
              </div>
          ...
          <div className="row contact-margin-top">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row">
                    ...
                    <div className="about-btn">
                      <button type="submit" className="button-one" disabled={submitting}>
                        {submitting ? (
            ...
            <div className="col-lg-6 col-md-12">
              <div className="contact-maps">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.066372371337!2d77.18480707541974!3d28.567769587018702!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1dfac9f3a21f%3A0x158d825ea30fe3c0!2sClimax%20Holidays!5e0!3m2!1sen!2sin!4v1752843569501!5m2!1sen!2sin"
                  width={600}
                  height={450}
                  style={{ border: 0 }}
                  allowFullScreen=""
