  ...
  return (
    <div>
      ...
      <section className="section_padding">
        <Container>
          <p>
            Welcome to  Climax Holidays Tour & Travels, a premier B2C travel portal. We
            are committed to safeguarding the privacy of our users. This Privacy
            Policy outlines how we collect, use, disclose, and protect your
            personal information. By accessing or using our services, you agree
          ...
          <div className="terms_item">
            ...
            <p>
              ...
              transactions on  Climax Holidays Tour & Travels, including bookings,
          ...
          <div className="terms_item">
            ...
            <p>
              ...
              communication preferences, within your  Climax Holidays Tour & Travels
              account.
            </p>
            <p>
          ...
          <div className="terms_item">
            ...
            <p>
              ...
              <a href="mailto:sales@climaxholidays.com">sales@climaxholidays.com</a>.
            </p>
          </div>
        </Container>
      </section>
