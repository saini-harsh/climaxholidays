...
const PopularTourSection = ({heading}) => {
  const swiperRef = useRef(null);
  const [data, setData] = useState([]);
  useEffect(() => {
    const dataFetch = async () => {
      const datas = await axios.get(
        `https://admin.climaxholidays.com/api/HolidayPackages/domestic_packages`
      );
      if (datas) {
  ...
  return (
    <div className="tour-category-sections">
      <div className="trip-category-section overflow-hidden pt-120">
        <img
          decoding="async"
          src="./Images/tour/banner-hq2.jpg"
          className="trip-bg"
          alt="heading-image"
        />
                  ...
                  <SwiperSlide>
                    ...
                    >
                      ...
                      <div className="trip-content">
                        <h4>
                          <Link to={`/${item.destination}/${item.slug}`}>
