...
const HolidayThemesSection = () => {
    ...
    useEffect(() => {
        const fetchThemes = async () => {
            try {
                const response = await axios.get("https://admin.climaxholidays.com/api/HolidayPackages/HolidayThemes");
                                        ...
                                        <div className="mt-30">
                                            <Swiper
                                                ...
                                                breakpoints={{
                                                    ...
                                                    "@0.50": { slidesPerView: 3, spaceBetween: 20 },
                                                    "@0.75": { slidesPerView: 4, spaceBetween: 20 },
                                                    "@1.00": { slidesPerView: 5, spaceBetween: 40 },
                                                    "@1.50": { slidesPerView: 6, spaceBetween: 20 },
                                                }}
