...
const FullDetail = ({ data,test,loading }) => {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: "Check out this holiday package from Climax Holidays!",
          url: shareUrl,
        });
      } catch (error) {
      ...
      try {
        ...
        Swal.fire("Link Copied", "Page URL copied to clipboard.", "success");
      } catch (err) {
        Swal.fire("Failed", "Unable to copy the URL.", "error");
      }
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://admin.climaxholidays.com/api/HolidayPackages/package_enquiry", {
        name,
        email,
        phone,
        adult,
        ...
        <Container>
          ...
          >
            ...
            <div className="tourPackageUnderLineIcon">
              <FaDownload  onClick={test}  disabled={loading} size={28} className="tourPackageUnderLineIcon1" />
              {loading && (
                <div className="spinner-container">
                  <div className="spinner"></div>
                </div>
              )}
              <FaShareAlt onClick={handleShare} size={28} className="tourPackageUnderLineIcon2" />
            </div>
          </div>
        </Container>
      </div>
            ...
            <div className="tourPackagefullDetailinner1">
              <div className="tourPackagefullDetailinnerMain">
               ...
               <Swiper
                  ...
                  className="mySwiper"
                >
                  {data.packagedetail.package_gallery?.map((item, index) => (
                  ...
                  <div className="tourPackageDetail">
                    ...
                    <div className="tourPackageDetailDays">
                      <p>
                        ...
                        {data.packagedetail.nights} {data.packagedetail.nights > 1 ? "Nights" : "Night"} &{" "}
                        {data.packagedetail.days} {data.packagedetail.days > 1 ? "Days" : "Day"}
                      </p>
                      <p>
                        <span className="tourPackageDetailDaySpan font-[600]">
                          Places to Visit:{" "}
                        </span>
                        {data.packagedetail.details_day_night	}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="tourPackageDetailIcons">
                  ...
                  <div>
                    ...
                    <div className="tourPackageDetailIconsPara2">
                      <p>
                        <span>Call Us:</span>+91 9599408232
                      </p>
                      <p>
                        <span>Mail Us:</span> sales@climaxholidays.com
                      </p>
                    </div>
                  </div>
                </div>
