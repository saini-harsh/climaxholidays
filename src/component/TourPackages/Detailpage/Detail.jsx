    ...
    useEffect(() => {
        const fetch = async () => {
            const res = await axios.get(
                `https://admin.climaxholidays.com/api/HolidayPackages/destinations/${pack}/${fullDetails}`
            );
            if (res) {
...
const [loading, setLoading] = useState(false);
    ...
    return (
        <>
            <div className="bg-[#ffffff] main_RESUSEA" ref={printRef}>
                {data && Object.keys(data).length > 0 && (
                    <div>
                        <div>
                            <div className="detailCardMainDiv">
                                <div className="detailCardMainDivInner1">
                                    ...
                                    <p className="detailCardMainDivInner1para2">
                                        <GiNightSleep color="#f73030" /> {data.packagedetail.nights}{" "}
                                        Nights / <WiDayCloudy color="#f73030" />{" "}
                            ...
                            <FullDetail data={data} test={handleExportPdf} loading={loading} />
                        </div>
                        ...
                        <Container>
                            <Row className="" style={{ position: "relative" }}>
                                <div className="col-12 mx-auto d-block">
                                    ...
                                    <h2 className="detailCardMainDivInner3head">
                                        <span className="text-b text-center">Similar </span>Packages
                                    </h2>
                                    ...
                                    >
                                        ...
                                        {data.similar_packages.map((item, index) => (
